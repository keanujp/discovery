...
object filters {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(65); 
  val nums = List(2, -4, 5, 7, 1);System.out.println("""nums  : List[Int] = """ + $show(nums ));$skip(63); 
  val furuits = List("apple", "pineapple", "orange", "banana");System.out.println("""furuits  : List[String] = """ + $show(furuits ));$skip(28); val res$0 = 
