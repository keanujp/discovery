...
object intsets {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(71); 
	...
	val t3 = t2 union t2;System.out.println("""t3  : week3.IntSet = """ + $show(t3 ))}
}
